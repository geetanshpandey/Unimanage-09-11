...
const LivechatPage = () => {
  return (
    <div>
      <Global 
    header="Live chat enables businesses to provide real-time support, " 
    headerpart="improving customer experience, satisfaction, and engagement." // Notice the space before 'make easy'
    desc="Live chat improves instant customer communication." 
