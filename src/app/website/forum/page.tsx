...
const ForumPage = () => {
  return (
    <div>
      <Global 
    header="Forums allow businesses to build communities, " 
    headerpart=" promote engagement, share knowledge, and gather customer insights." // Notice the space before 'make easy'
    desc="Forums enhance community interaction and support." 
    cardHeading="Forum" 
