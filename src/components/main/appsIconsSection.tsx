...
import PointOfSaleIcon from '@/app/icons/Sales.png';
...
export default function AppIconsSection() {
  ...
  return (
    <div className="relative bg-gradient-to-b from-gray-200 via-gray-300 to-white py-2 min-h-screen">
      ...
      <div className="-mt-20 absolute bottom-20 right-4 flex items-center space-x-2 hidden sm:block">
        <span className="text-sm text-gray-700 font-bold">With Unimanage</span>
